...
class Routes {
    ...
    initializeUserRoutes(prefix) {
        ...
        this.router.post(`${prefix}/dashboard/createTicket`, this.authentication.Auth, this.ticketController.createTicket);
    ...
    initiaizeAdminRoutes(prefix) {
        ...
        this.router.post(`${prefix}/dashboard/createOrg`, this.authentication.AdminAuth, this.organizationController.createOrg);
